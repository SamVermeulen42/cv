...
\name{Ir. Sam Vermeulen}{}
\address{Margrietstraat 95A, 9170 Meerdonk, Belgium}
\mobile{+ 32 498 25 33 28}

\email{sam.verm@yahoo.com}
%\homepage{www.posquit0.com}
%\github{SamVermeulen42}
%\linkedin{posquit0}
%\skype{skypeid}
...
%\xing{xing name}
\extrainfo{15 March 1993}
\photo[rectangle,noedge,right]{Sam}
...
\makecvfooter{\today}{Sam Vermeulen~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
